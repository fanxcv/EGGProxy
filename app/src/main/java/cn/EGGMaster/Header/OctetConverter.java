 ...
 */
package cn.EGGMaster.Header;

/**
 * OctetConverter is a utility singleton class for converting IP octets to and
...
public final class OctetConverter {
  ...
  /**
   * Converts a 32-bit word representation of an IPv4 address to a string
   * representation.
   *
   * @param buffer  The StringBuffer to which to append the string.
  ...
  /**
   * Converts a 32-bit word representation of an IPv4 address to a byte array of
   * octets.
   *
