...
/**
 * UDPPacket extends {@link IPPacket} to handle UDP packets. The UDP packet
 * structure is described in <a
 * href="http://www.ietf.org/rfc/rfc0768.txt?number=768">RFC 768</a>.
 *
...
public class UDPPacket extends IPPacket {
  ...
  /**
   * Copies the contents of a UDPPacket. If the current data array is of
